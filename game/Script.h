#ifndef H_GAME_SCRIPT
#define H_GAME_SCRIPT
...
std::optional<ActionType> getScriptActionTypeByValue(uint32_t);
std::optional<ConditionType> getScriptConditionTypeByValue(uint32_t);
std::optional<ParameterType> getScriptParameterTypeByValue(uint32_t);
